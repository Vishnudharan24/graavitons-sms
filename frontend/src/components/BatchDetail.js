      ...
      {activeTab === 'students' && (
        <>
          ...
          <div className="management-buttons">
            ...
            <button className="btn btn-report" onClick={handleDownloadAllProgressReports} disabled={bulkProgressPdfLoading || students.length === 0}>
              {bulkProgressPdfLoading
                ? `⏳ Generating Progress PDFs... (${bulkProgressPdfCount.done}/${bulkProgressPdfCount.total})`
                : '📄 Download All Students Progress PDFs'}
            </button>
          </div>
