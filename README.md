...
After DB is up, load [database/db_schema.txt](database/db_schema.txt) into your Render PostgreSQL instance.

You can do this from a PostgreSQL client using the External Database URL from Render.
